...
const MovieSlider = ({ category }) => {
    ...
    const formattedCategory = category.charAt(0).toUpperCase() + category.replaceAll("_", " ").slice(1);
    ...
    return (
        <div className='text-white bg-black relative px-5 md:px-20' onMouseEnter={() => setShowArrows(true)} onMouseLeave={() => setShowArrows(false)}>
            ...
            {/* scrollbar-hide class is coming from the installed tailwind scrollbar hide package */}
